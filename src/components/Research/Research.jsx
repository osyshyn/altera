				...
				<div id='research' className='research'>
					<div className='research-right'>
						...
						<div className='research-right-text'>
							We are building on decades of computational neuroscience research
							to build digital human beings that live, love and grow with us. We
							shut down our applied research lab at MIT to advance and
							productize the leading agent research in gaming.
						</div>
					</div>
